    ...
    if ((e && typeof e == 'object') || typeof e == 'function')
      for (let i of Fe(e))
        !Be.call(t, i) &&
          ...
          ae(t, i, {
            get: () => e[i],
            enumerable: !(r = Ae(e, i)) || r.enumerable,
          });
    return t;
  };
  var qe = (t, e, n) => (
...
`,
      ...
      (t.Index = function (e) {
        ...
        (t.Index.prototype.query = function (e) {
          ...
          for (
            var N = t.Set.complete, M = t.Set.empty, l = 0;
            l < this.fields.length;
            l++
          ) {
            var y = this.fields[l];
          ...
          for (
            ...
            for (
              ...
              var p = m[w],
                ...
                _;
              i[p] === void 0
                ? ((b = t.idf(this.invertedIndex[p], this.documentCount)),
                  (i[p] = b))
                : (b = i[p]),
                (k =
                  (b * ((this._k1 + 1) * y)) /
  ...
  function me(t, e) {
    ...
    for (; o != -1; )
      i.push(
        te(t.substring(s, o)),
        `<b>${te(t.substring(o, o + r.length))}</b>`
      ),
        (s = o + r.length),
        (o = n.indexOf(r, s));
...
`),
  ...
  async function Se() {
    ...
    let n = await (await fetch(window.navigationData)).arrayBuffer(),
      ...
      i = await new Response(r).json();
    (K = document.documentElement.dataset.base),
      K.endsWith('/') || (K += '/'),
      (t.innerHTML = '');
